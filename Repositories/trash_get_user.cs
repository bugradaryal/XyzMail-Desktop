...
namespace mail
{
    ...
    public class trash_get_user
    {
        ...
        public virtual ICollection<trash_get_user_dosyalar> Dosyalar { get; set; }
        public virtual ICollection<trash_get_user_bodyfile> Bodyfiles { get; set; }

        public trash_get_user()
        {
            Dosyalar = new HashSet<trash_get_user_dosyalar>();
            Bodyfiles = new HashSet<trash_get_user_bodyfile>();
        }
    }
    ...
    public class trash_get_user_dosyalar
    {
        ...
        public virtual trash_get_user TrashGetUser { get; set; }
    }
